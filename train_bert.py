...
from transformers import AdamW, BertConfig, BertForMaskedLM, BertTokenizer, get_scheduler
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train BertForMaskedLM with Masked Language Modeling")
